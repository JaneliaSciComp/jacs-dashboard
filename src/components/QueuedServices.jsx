...
class QueuedServices extends Component {
  ...
  componentDidMount() {
    ...
    fetch(runningServices, {
      ...
      .then((json) => {
        this.setState({ queued: json, loaded: true });
  ...
  render() {
    ...
    const services = this.state.queued.resultList;

    return (
      <Grid container spacing={8}>
        <Grid item xs={12}>
          <Typography align="left" variant="display2">Queued Services</Typography>
        </Grid>
        <Grid item xs={12}>
...
QueuedServices.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(QueuedServices);
