...
function constructCronBody(formArgs) {
  ...
  body['successEmailNotifications'] = meta.get('successEmailNotifications');
  body['failureEmailNotifications'] = meta.get('failureEmailNotifications');
